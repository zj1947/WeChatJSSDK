...
public abstract class ImageWorker {
     ...
     */
    public void loadImage(Object data, ImageView imageView,ImgLoaderListener imgLoaderListener) {
        if (data == null) {
            return;
        }

        Bitmap bitmap = null;
        String strUrl= String.valueOf(data);
        if (mImageCache != null) {
            bitmap = mImageCache.getBitmapFromMemCache(strUrl);
        }

        if (null!=imgLoaderListener){
            imgLoaderListener.onStart(strUrl, imageView);
        }
        ...
        if (bitmap != null) {
            ...
            final BitmapWorkerTask task = new BitmapWorkerTask(imageView,imgLoaderListener);
     ...
     *            {@link ImageWorker#loadImage(Object, android.widget.ImageView, ImgLoaderListener)}
    ...
    /**
     * 确保ImageView执行的是它对应的Task，返回false；否则取消任务,返回true
    ...
    private class BitmapWorkerTask extends AsyncTask<Object, Void, Bitmap> {
        ...
        private ImgLoaderListener imgLoaderListener;

        public BitmapWorkerTask(ImageView imageView,ImgLoaderListener imgLoaderListener) {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            if (bitmap != null && imageView != null) {
                ...
                setImageBitmap(imageView, bitmap,imgLoaderListener);
            }
        }

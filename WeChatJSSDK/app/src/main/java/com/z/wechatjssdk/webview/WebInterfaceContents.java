...
public class WebInterfaceContents {
    ...
    public static final String INTERFACE_NM_PRE_IMG="previewImage";
    public static final String INTERFACE_NM_UPLOAD_IMG="uploadImage";
    public static final String INTERFACE_NM_CHOOSE_IMG="chooseImage";
    public static final String INTERFACE_NM_GO_BACK="goBack";
